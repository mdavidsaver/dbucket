...
class TestXCode(unittest.TestCase):
    ...
    data = [
        ...
        (b'ss',
          ...
          b'\x1e\x00\x00\x00org.freedesktop.NetworkManager\x00\x00\x05\x00\x00\x00State\x00',
        ),
    ]
...
class TestDecode(unittest.TestCase):
    data = [
        ...
        # call Get()
        (b'yyyyuua(yv)',
          (108, 1, 0, 1, 45, 4, [(1, '/org/freedesktop/NetworkManager'), (3, 'Get'), (2, 'org.freedesktop.DBus.Properties'), (6, 'org.freedesktop.NetworkManager'), (8, b'ss')]),
          b'l\x01\x00\x01-\x00\x00\x00\x04\x00\x00\x00\x90\x00\x00\x00\x01\x01o\x00\x1f\x00\x00\x00/org/freedesktop/NetworkManager\x00\x03\x01s\x00\x03\x00\x00\x00Get\x00\x00\x00\x00\x00\x02\x01s\x00\x1f\x00\x00\x00org.freedesktop.DBus.Properties\x00\x06\x01s\x00\x1e\x00\x00\x00org.freedesktop.NetworkManager\x00\x00\x08\x01g\x00\x02ss\x00'
        ),
    ]
